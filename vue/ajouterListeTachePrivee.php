...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li ><a href="index.php?action=privee">mes taches</a></li>
...
<div class="container">
    <form class="form-horizontal"  method="post" name="myformAjTac" id="myformAjTac">
        <div class="form-group">
            <label class="control-label col-sm-2" for="nom">nom:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="donNomListe" name="donNomListe" placeholder="Entrer nom">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2"  for="Description">Description:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="donDescription" id="donDescription" placeholder="Entrer la description">
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit"  name="action" value="verifListePrivee" class="btn btn-default">ajouterListe
